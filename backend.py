...
Return ONLY valid JSON: {{"score": 0.85, "reason": "brief explanation"}}"""
    ...
    def generate_response(self, query: str, context_docs: List[Dict], task: str = "qna") -> Dict:
        ...
        if task == "qna":
            system_prompt = "You are an AI Regulatory Compliance Assistant for Capital Markets. Answer using ONLY the provided context. Use [Source X] citations. End with **Risk Tag: Low/Medium/High**."
